...
namespace WSC {
    ...
    public partial class dsCustomer : global::System.Data.DataSet {
        ...
        public partial class customerDataTable : global::System.Data.TypedTableBase<customerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public customerRow AddcustomerRow(string custID, string custFirstName, string custLastName, string custAddress, string custCity, string custState, string custZip, string custPhone, string custEmail) {
            ...
            private void InitClass() {
                ...
                this.columncustZip.AllowDBNull = false;
                this.columncustZip.MaxLength = 5;
...
namespace WSC.dsCustomerTableAdapters {
    ...
    public partial class customerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `customer` WHERE ((`custID` = @p1))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `customer` (`custID`, `custFirstName`, `custLastName`, `custAddress`," +
                " `custCity`, `custState`, `custZip`, `custPhone`, `custEmail`) VALUES (@p1, @p2," +
            ...
            param.IsNullable = true;
            param.SourceColumn = "custFirstName";
            this._adapter.InsertCommand.Parameters.Add(param);
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            ...
            param.MySqlDbType = global::MySql.Data.MySqlClient.MySqlDbType.VarChar;
            param.IsNullable = true;
            param.SourceColumn = "custLastName";
            this._adapter.InsertCommand.Parameters.Add(param);
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `customer` SET `custID` = @p1, `custFirstName` = @p2, `custLastName` = @p3" +
                ", `custAddress` = @p4, `custCity` = @p5, `custState` = @p6, `custZip` = @p7, `cu" +
                "stPhone` = @p8, `custEmail` = @p9 WHERE ((`custID` = @p10))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `custID`, `custFirstName`, `custLastName`, `custAddress`, `custCity`, `cus" +
                "tState`, `custZip`, `custPhone`, `custEmail` FROM `customer`";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsCustomer.customerDataTable dataTable) {
